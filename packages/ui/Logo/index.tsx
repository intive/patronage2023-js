...
export const LogoStyledContainer = styled.div<ContainerProps>`
	...
	*/
	background: ${({ white }) => white ? "#1E4C40" : "none" };
	${({ logoWidth }) =>
		logoWidth && css`
			width: ${logoWidth + "px"};
...
export const LogoSignet = styled.div<LogoSignetProps>`
	background: url(${({ white }) => white ? logoVersions.whiteURL : logoVersions.colorURL}) no-repeat center / contain;
	height: 100%;
	${({ logoWidth }) =>
		logoWidth && css`
